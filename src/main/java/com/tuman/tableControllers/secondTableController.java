...
public class secondTableController extends  mainController {
    @FXML
    ...
    void CountUp(ActionEvent event) {
        ...
        cashPay.setOnAction(e-> {
            ...
            money.setCashRevenue( mainController.money.getCashRevenue() + Main.secondTable.getSum());
            ...
            Main.secondTable.deleteAllPositions();

            stage.close();
        });
        cardPay.setOnAction(e-> {
            money.setCardRevenue( mainController.money.getCardRevenue() + Main.secondTable.getSum());
            staticRevenueLabel.setText(String.valueOf(money.getTotalMoney()));
        ...
        transferPay.setOnAction(e -> {
            mainController.money.setTransferRevenue( mainController.money.getTransferRevenue() + Main.secondTable.getSum());
    ...
    void addPosition(ActionEvent event) {
        if (posIsNotNull(firstPos) ) {
            Main.secondTable.addPos( firstPos.getValue().toString(), Integer.parseInt(firstCount.getText()), Integer.parseInt(firstPrice.getText()));
        }
        if (posIsNotNull(secondPos)) {
            Main.secondTable.addPos( secondPos.getValue().toString(), Integer.parseInt(secondCount.getText()), Integer.parseInt(secondPrice.getText()) );
        }
        if (posIsNotNull(thirdPos)) {
            Main.secondTable.addPos( thirdPos.getValue().toString(), Integer.parseInt(thirdCount.getText()), Integer.parseInt(thirdPrice.getText()));
        }
        if (posIsNotNull(fourPos)) {
            Main.secondTable.addPos( fourPos.getValue().toString(), Integer.parseInt(fourCount.getText()), Integer.parseInt(fourPrice.getText()));
        }
        clearAllPos();
    }
    ...
    void openTableCheck(ActionEvent event) {
        ...
        if (!Main.secondTable.getPositions().isEmpty()){
            for (int i = 0; i< (Main.secondTable.getPositions().size()); i++){
                lis.add(new tableModel(Main.secondTable.getPositions().get(i),String.valueOf(Main.secondTable.getAmount().get(i)),String.valueOf(Main.secondTable.getPrice().get(i)),
                        String.valueOf(Main.secondTable.getAmount().get(i)*Main.secondTable.getPrice().get(i)) ));
            }}
        ...
        Label totalLabel = new Label("Итого:" + Main.secondTable.getSum());
        ...
        changeButton.setOnAction(e->
        {
            ...
            if (!table.getSelectionModel().isEmpty()) {
                ...
                confirm.setOnAction(o-> {
                    Main.secondTable.changePositionValues(table.getSelectionModel().getFocusedIndex(), fieldPosition.getText(), fieldAmount.getText(), fieldPrice.getText());
                    st.close();
                    stage.close();
                });
                deletePosition.setOnAction(p -> {
                    Main.secondTable.deletePositionValues(table.getSelectionModel().getFocusedIndex());
                    st.close();
                    stage.close();
                });
