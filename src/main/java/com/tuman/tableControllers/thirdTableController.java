...
public class thirdTableController extends mainController implements Initializable {
    @FXML
    ...
    void CountUp(ActionEvent event) {
        ...
        cashPay.setOnAction(e-> {
            ...
            money.setCashRevenue( money.getCashRevenue() + Main.thirdTable.getSum());
            ...
            Main.thirdTable.deleteAllPositions();

            stage.close();
        });
        cardPay.setOnAction(e-> {
            money.setCardRevenue( money.getCardRevenue() + Main.thirdTable.getSum());
            staticRevenueLabel.setText(String.valueOf(money.getTotalMoney()));
        ...
        transferPay.setOnAction(e -> {
            money.setTransferRevenue( money.getTransferRevenue() + Main.thirdTable.getSum());
    ...
    void addPosition(ActionEvent event) {
        if (posIsNotNull(firstPos) ) {
            Main.thirdTable.addPos( firstPos.getValue().toString(), Integer.parseInt(firstCount.getText()), Integer.parseInt(firstPrice.getText()));
        }
        if (posIsNotNull(secondPos)) {
            Main.thirdTable.addPos( secondPos.getValue().toString(), Integer.parseInt(secondCount.getText()), Integer.parseInt(secondPrice.getText()) );
        }
        if (posIsNotNull(thirdPos)) {
            Main.thirdTable.addPos( thirdPos.getValue().toString(), Integer.parseInt(thirdCount.getText()), Integer.parseInt(thirdPrice.getText()));
        }
        if (posIsNotNull(fourPos)) {
            Main.thirdTable.addPos( fourPos.getValue().toString(), Integer.parseInt(fourCount.getText()), Integer.parseInt(fourPrice.getText()));
        }
        clearAllPos();
    }
    ...
    void openTableCheck(ActionEvent event) {
        ...
        if (!Main.thirdTable.getPositions().isEmpty()){
            for (int i = 0; i< (Main.thirdTable.getPositions().size()); i++){
                lis.add(new tableModel(Main.thirdTable.getPositions().get(i),String.valueOf(Main.thirdTable.getAmount().get(i)),String.valueOf(Main.thirdTable.getPrice().get(i)),
                        String.valueOf(Main.thirdTable.getAmount().get(i)*Main.thirdTable.getPrice().get(i)) ));
            }}
        ...
        Label totalLabel = new Label("Итого:" + Main.thirdTable.getSum());
        ...
        changeButton.setOnAction(e->
        {
            ...
            if (!table.getSelectionModel().isEmpty()) {
                ...
                confirm.setOnAction(o-> {
                    Main.thirdTable.changePositionValues(table.getSelectionModel().getFocusedIndex(), fieldPosition.getText(), fieldAmount.getText(), fieldPrice.getText());
                    st.close();
                    stage.close();
                });
                deletePosition.setOnAction(p -> {
                    Main.thirdTable.deletePositionValues(table.getSelectionModel().getFocusedIndex());
                    st.close();
                    stage.close();
                });
